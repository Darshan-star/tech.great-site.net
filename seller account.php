<?php
if(isset($_COOKIE['email']) && isset($_COOKIE['pan'])){
    ...
    <div class="Background">
        ...
        <div class="Details bc">
            <div class="Center">
                <h1>Stay Conneted</h1>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum reiciendis facere fuga ipsa magni facilis autem
                    ducimus quibusdam repellat ratione! Minima quam placeat dolor excepturi illum aperiam eius iusto voluptatum?
                </p>
            </div>
            <div class="ContactField login">
                <div class="Info">
                    <div class="Address">
                        <h1>Want to start your own business</h1>
                        <p>
                            If you are willing to start your own business, then this will be a perfect place for you.<br>
                            You can start your own business only with 3 easy steps.
                        </p>
                        <h1>Step 1:</h1>
                        <p>Create Your Account on <a href="gstech.com" style="color: #00f; text-shadow: none;">Wizards.com</a></p>
                        <h1>Step 2:</h1>
                        <p>Open Your Seller Account Here</p>
                        <h1>Step 3:</h1>
                        <p>Add Your Products</p>
                    </div>
                    <div class="Address">
                        <h1>Address</h1>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. At, nisi recusandae cum quis pariatur quia!</p>
                    </div>
                    <div class="Address">
                        <h1>Phone</h1>
                        <p>+91 9876543210</p>
                ...
                <form action="sign_up.php" method="post" class="sign_up">
                    <div class="Form">
                        ...
                        <div class="EntryFields">
                            <input type="email" autocomplete="on" required placeholder="Email" name="email"  <?php if(isset($_COOKIE['email'])){?>value="<?php echo $_COOKIE['email']?>"<?php }?>/>
                            <input type="text" autocomplete="on" required placeholder="Password" name="password"/>
                            <input type="text" autocomplete="on" required placeholder="Account Number" name="account"/>
                            <input type="text" autocomplete="on" required placeholder="PAN" name="pan"/>
                            <input type="number" autocomplete="on" required placeholder="Aadhaar Number" name="aadhaar"/>
                            <input type="text" autocomplete="on" required placeholder="Your Full Address" name="address"  <?php if(isset($_COOKIE['address'])){?>value="<?php echo $_COOKIE['address']?>"<?php }?>/>
                            <input type="number" autocomplete="on" required placeholder="Area Pincode" name="pincode"  <?php if(isset($_COOKIE['pincode'])){?>value="<?php echo $_COOKIE['pincode']?>"<?php }?>/>
                            <input type="hidden" name="page" value="seller account.php"/>
                            <div class="Terms">
                              <input type="checkbox" required name="terms" id="terms">
                              <label for="terms"> I accept all the Terms &amp; Conditions</label>
                              </div>
                        </div>
                        <div class="btn" id="bt">
                          <button type="reset" class="reset" style="display: none;"></button>
                            ...
                            <a href="./profile.php">
                                <button type="button" style="background: #f00; color:#fff;">cancel</button>
                            </a>
                        </div>
