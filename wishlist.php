...
<body>
  ...
  <div class="Container">
      <div class="Details">
        <div class="SellerProductSection" style="display: flex;">
          <?php
            $que = "SELECT * FROM wishlist WHERE id = ".$_COOKIE['id'].";";
            if($counts = $conn -> query($que)){
                        ...
                        <div class="Image">
                            <?php
                              ...
                              if($prep = $conn -> query($sl)){
                                if($prep -> num_rows > 0){
                            ?>
                              <div type="button" class="wish-listed" onclick="wish(<?php echo $data['prod_id'];?>)"><i class="bx bxs-heart"></i></div>
                            <?php
                                }
                                else{
                            ?>
                              <div type="button" class="wish-list" onclick="wish(<?php echo $data['prod_id'];?>)"><i class="bx bxs-heart"></i></div>
                            <?php
                                }
                              }
                            ?>
                            <img onclick="prod(<?php echo $data['prod_id'];?>)" src="<?php echo $data['images0'];?>" alt="">
                        </div>
                        <div class="ProductDescription" onclick="prod(<?php echo $data['prod_id'];?>)" >
                                <div class="ProductName">
                                    <h1 style="text-align:center;"><?php echo $data['prod_name'];?></h1>
                                </div>
                                <div class="ProductCost">
                                    <div class="OriginalCost" style="width:fit-content;margin:0 auto;">
                                        <h1><?php echo $data['prod_dis_price'];?></h1><h3><?php echo $data['prod_discount'];?>% off</h3>
                                    </div>
                                </div>
                        </div>
                    </div>
  ...
  <form action="./sign_up.php" method="post">
      <input type="hidden" name="page" value="./wishlist.php">
