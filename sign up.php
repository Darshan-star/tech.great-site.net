            ...
            <div class="ContactField login">
                <div class="Info">
                    ...
                    <div class="btn">
                        ...
                        <button>Sign in with Google<sup>+</sup> </button>
                        <button><img src="./images/twitter-512.png" alt="sd"> Twitter</button>
                    </div>
                ...
                <form action="sign_up.php" method="post" class="sign_up">
                    <div class="Form">
                        ...
                        <div class="EntryFields">
                            <input type="text" autocomplete="on" minlength="2" maxlength="50" placeholder="Full Name" name="name"/>
                            <input type="email" autocomplete="on" placeholder="Email" name="email"/>
                            <input type="text" autocomplete="off" minlength="8" maxlength="25" placeholder="Password" name="pass"/>
                            <input type="text" autocomplete="off"  minlength="8" maxlength="25" placeholder="Confirm Password" name="cpass"/>
                            <input type="number" autocomplete="on" placeholder="Mobile Number" name="mobile"/>
                            <input type="hidden" name="page" value="sign up.php"/>
                            <div class="Terms">
