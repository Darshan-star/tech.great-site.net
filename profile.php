            ...
            <div class="Details">
                ...
                if(isset($_COOKIE['email'])){?>
                    <div class="Image">
                      <?php
                        if(isset($_COOKIE['image']) && file_exists($_COOKIE['image'])){?>
                        <img style="cursor: pointer; filter: invert(0%);" class="pro-image" src="<?php echo $_COOKIE['image'];?>" alt="">
                        
                      <?php 
                      }
                      elseif(!isset($_COOKIE['image'])){
                        ?>
                        <img style="cursor: pointer; filter: invert(50%);" class="pro-image" src="./images/Images/user_icon.png" alt="">
                      <?php
                      }
                      ?>
                    ...
                    <form action = "./sign_up.php" method = "POST" enctype = "multipart/form-data">
                      <input type="file" accept=".jpeg, .jpg, .png" style = "display:none;" class = "image-file" name = "profile_image">
                      <input type="hidden" name="page" value="profile.php/profile image">
                      <button type="submit" class = "image-sub-btn" style="display: none;"></button>
          ...
          <div class="Details">
            ...
            <form action="./sign_up.php" class="b" method="post">
                <div class="EntryField grid gdp">
                    ...
                    <?php }?>
                        <div class="INFO address" <?php if(!isset($_COOKIE['address'])){?> style="display: none;"<?php }?>><h1><?php echo $_COOKIE['address'];?></h1></div>
                        <div class="INFO pin" <?php if(!isset($_COOKIE['pincode'])){?> style="display: none;"<?php }?>><h1><?php echo $_COOKIE['pincode'];?></h1></div>
                </div>
            </form>
            <!--<gender>
              <h1>Your Gender</h1>
